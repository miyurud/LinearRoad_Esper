...
public class AccountBalance
{
    ...
    public AccountBalance() throws Exception
    {
        ...
        configuration.addEventType("TollCalculationEvent", TollCalculationEvent.class.getName());
        configuration.addEventType("AccountBalanceEvent", AccountBalanceEvent.class.getName());
        EPServiceProvider engine = EPServiceProviderManager.getDefaultProvider(configuration);
        
        // Initialize engine
        log.info("Creating sample statement");
        AccountBalanceStatement stmt = new AccountBalanceStatement();
