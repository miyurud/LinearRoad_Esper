...
public class Toll
{
    ...
    public Toll() throws Exception
    {
        ...
        configuration.addEventType("LAVEvent", LAVEvent.class.getName());
        configuration.addEventType("NOVEvent", NOVEvent.class.getName());
        EPServiceProvider engine = EPServiceProviderManager.getDefaultProvider(configuration);
        
        // Initialize engine
        log.info("Creating sample statement");
        TollStatement stmt = new TollStatement();
